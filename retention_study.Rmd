...
colnames(pre_201620) <- c("PIDM", "TERM_GPA_201620", "CREDITS_ATT_201620", 
...
colnames(pre_201540) <- c("PIDM", "TERM_GPA_201540", "CREDITS_ATT_201540", 
...
pre_join <- pre_201620 %>% full_join(pre_201540, by = "PIDM")

test_join <- elig_2016_set %>% inner_join(pre_join, by = "PIDM")
